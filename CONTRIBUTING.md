...
[T_Launcher Code of Conduct](CODE_OF_CONDUCT.md).
...
<!-- Omitted: Guidelines for reporting bugs. -->
...
Documentation changes are also welcome! The documentation is located in the `docs/` directory.
