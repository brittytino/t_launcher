...
import de.brittytino.android.launcher.apps.DetailedPinnedShortcutInfo
import de.brittytino.android.launcher.apps.PinnedShortcutInfo
import de.brittytino.android.launcher.apps.getPrivateSpaceUser
...
fun removeUnusedShortcuts(context: Context) {
    ...
    fun getShortcuts(profile: UserHandle): List<ShortcutInfo>? {
        return try {
            ...
            // https://github.com/brittytino/launcher/issues/116
            return null
        }
    }
