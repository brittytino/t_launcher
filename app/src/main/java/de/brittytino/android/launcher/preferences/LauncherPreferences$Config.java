package de.brittytino.android.launcher.preferences;
...
import de.brittytino.android.launcher.preferences.list.AppNameFormat;
import de.brittytino.android.launcher.preferences.list.ListLayout;
import de.brittytino.android.launcher.preferences.serialization.MapAbstractAppInfoStringPreferenceSerializer;
import de.brittytino.android.launcher.preferences.serialization.SetAbstractAppInfoPreferenceSerializer;
import de.brittytino.android.launcher.preferences.serialization.SetPinnedShortcutInfoPreferenceSerializer;
import de.brittytino.android.launcher.preferences.serialization.SetWidgetPanelSerializer;
import de.brittytino.android.launcher.preferences.serialization.SetWidgetSerializer;
import de.brittytino.android.launcher.preferences.theme.Background;
import de.brittytino.android.launcher.preferences.theme.ColorTheme;
import de.brittytino.android.launcher.preferences.theme.Font;
import eu.jonahbauer.android.preference.annotations.Preference;
import eu.jonahbauer.android.preference.annotations.PreferenceGroup;
import eu.jonahbauer.android.preference.annotations.Preferences;

@Preferences(
        name = "de.brittytino.android.launcher.preferences.LauncherPreferences",
        makeFile = true,
        r = R.class,
        value = {
                @PreferenceGroup(name = "internal", prefix = "settings_internal_", suffix = "_key", value = {
                        ...
                        // see PREFERENCE_VERSION in de.brittytino.android.launcher.preferences.Preferences.kt
