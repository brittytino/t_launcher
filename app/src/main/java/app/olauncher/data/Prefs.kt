...
class Prefs(context: Context) {
    ...
    private val VISUAL_DETOX = "VISUAL_DETOX"
    ...
    var isVisualDetox: Boolean
        get() = prefs.getBoolean(VISUAL_DETOX, false)
        set(value) = prefs.edit { putBoolean(VISUAL_DETOX, value).apply() }
